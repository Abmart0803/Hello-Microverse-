...
- Hello Microverse is my first project in Microverse and it is aim at knowing how to use linters, .gitignore, HTML and CSS.
...
- cd my-folder
- git clone git@github.com:Abmart0803/Hello-Microverse-.git
...
I would like to thank Microverse for giving us this task to start off our web development journey.
